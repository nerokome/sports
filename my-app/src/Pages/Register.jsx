...
return (
    ...
    >
        <motion.div
            className="w-full max-w-md mx-auto mt-10 bg-white p-6 sm:p-8 rounded-lg shadow-lg"
            initial={{ scale: 0.95 }}
            animate={{ scale: 1 }}
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="w-full py-2 mt-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200"
                >
                    Create an account
                </motion.button>
            </form>
